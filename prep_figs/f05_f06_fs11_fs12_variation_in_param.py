...
def plot_fig(res_path_dict, model_name):
    ...
    if model_name == "P_model":
        ...
        plt.savefig("./figures/f05_main_p_param.png", dpi=300, bbox_inches="tight")
        plt.savefig("./figures/f05_main_p_param.pdf", dpi=300, bbox_inches="tight")
        plt.close("all")
        ...
        os.makedirs(fig_path, exist_ok=True)
        plt.savefig(
            "./supplement_figs/fs11_suppli_p_param.png", dpi=300, bbox_inches="tight"
        )
        plt.savefig(
            "./supplement_figs/fs11_suppli_p_param.pdf", dpi=300, bbox_inches="tight"
        )
        plt.close("all")
        ...
        fig_path = Path("figures")
        os.makedirs(fig_path, exist_ok=True)
        plt.savefig("./figures/f06_main_lue_param.png", dpi=300, bbox_inches="tight")
        plt.savefig("./figures/f06_main_lue_param.pdf", dpi=300, bbox_inches="tight")
        plt.close("all")
        ...
        os.makedirs(fig_path, exist_ok=True)
        plt.savefig(
            "./supplement_figs/fs09_suppli_lue_param.png",
            dpi=300,
            bbox_inches="tight",
        )
        plt.savefig(
            "./supplement_figs/fs09_suppli_lue_param.pdf",
            dpi=300,
            bbox_inches="tight",
        )
        plt.close("all")
