...
def plot_fig_main(result_paths):
    ...
    plt.savefig(
        "./supplement_figs/fs10_nnse_p_hr_climveg.png", dpi=300, bbox_inches="tight"
    )
    plt.savefig(
        "./supplement_figs/fs10_nnse_p_hr_climveg.pdf", dpi=300, bbox_inches="tight"
    )
    plt.close("all")
    ...
    os.makedirs(fig_path, exist_ok=True)
    plt.savefig(
        "./supplement_figs/fs11_nnse_p_yy_climveg.png", dpi=300, bbox_inches="tight"
    )
    plt.savefig(
        "./supplement_figs/fs11_nnse_p_yy_climveg.pdf", dpi=300, bbox_inches="tight"
    )
    plt.close("all")
