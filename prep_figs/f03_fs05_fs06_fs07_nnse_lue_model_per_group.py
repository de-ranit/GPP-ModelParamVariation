...
def plot_fig_main(result_paths):
    ...
    os.makedirs(fig_path, exist_ok=True)
    plt.savefig("./supplement_figs/fs05_bias_lue.png", dpi=300, bbox_inches="tight")
    plt.savefig("./supplement_figs/fs05_bias_lue.pdf", dpi=300, bbox_inches="tight")
    plt.close("all")
    ...
    fig_path = Path("supplement_figs")
    os.makedirs(fig_path, exist_ok=True)
    plt.savefig("./supplement_figs/fs06_corr_lue.png", dpi=300, bbox_inches="tight")
    plt.savefig("./supplement_figs/fs06_corr_lue.pdf", dpi=300, bbox_inches="tight")
    plt.close("all")
